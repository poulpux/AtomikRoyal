...
public class EnviroManager : SingletonMother<EnviroManager>
{
    ...
    {
        binaryMaskMap = new EnviroCase[_StaticEnvironement.lenght / _StaticEnvironement.tabResolution, _StaticEnvironement.height / _StaticEnvironement.tabResolution];
        for (int i = 0; i < _StaticEnvironement.lenght / _StaticEnvironement.tabResolution; i++)
        {
            for (int y = 0; y < _StaticEnvironement.height / _StaticEnvironement.tabResolution; y++)
